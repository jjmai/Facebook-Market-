...
INSERT INTO listings OVERRIDING SYSTEM VALUE VALUES (19, 2, '2021-12-05', 'Surface lapto', 'https://images.unsplash.com/photo-1633113211800-4acbb59fc254?ixlib=rb-1.2.1&ixid=MnwxMjA3fDF8MHxlZGl0b3JpYWwtZmVlZHwyMXx8fGVufDB8fHx8&w=1000&q=80');
SELECT setval(pg_get_serial_sequence('listings', 'id'), max("id")) FROM "listings";
...
INSERT INTO listing_categories VALUES (1, 19);
